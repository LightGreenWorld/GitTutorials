...
list11 = list(tuple10)
list12 = list(set10)
#딕셔너리는 이름을 가지고 리스트를 만든다.
list13 = list(dict10)
#이름을 가지고 리스트를 만든다
list14 = list(dict10.keys())
#값을 가지고 리스트를 만든다.
list15 = list(dict10.values())
#(이름, 값)의 튜플이 생성되고 이 튜플들이 들어있는 리스트를 만든다.
list16 = list(dict10.items())
