...
if __name__ == '__main__' :
    ...
    # 모듈 이름을 생략한다.
    # 단, 같은 이름의 함수, 클래드 등이 다른 모듈에는
    # 없어야 한다.
    # 지정된 모듈의 함수나 클래스 중에 일부를 생략해서
    # 사용하고 싶을 때..
    ...
    # 모듈명에 별칭을 부여한다.
    import wrtboxgsefgwl as wrt

    wrt.wrt_function1()
    wrt.wrt_function2()

    # 다른 패키지의 모듈 사용
    # import pkg1.pkg1_sub1
