#for문: 컨테이너 타입이 관리하는 값의 개수 만큼 반복한다.
...
#파이썬에서는 값을 담을 변수를 반드시 작성해야 하는 부분인 경우
#값을 받고 싶지 않다면 변수 대신 _ 를 사용
for _ in a1 :
    print('for 2')
...
#enumerate를 활용하여 for문을 사용하면 갑 뿐만 아니라 반복회차를 파악할 수 있다.
